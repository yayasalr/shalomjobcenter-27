          ...
          <div className="mb-10 bg-white rounded-lg shadow-md p-6 md:p-8">
            ...
            <ScrollAnimation direction="left" delay={0.4}>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                <div id="gardiennage" className="bg-gray-50 p-4 rounded-lg">
                ...
                <div id="protection" className="bg-gray-50 p-4 rounded-lg">
                ...
                <div id="conseil" className="bg-gray-50 p-4 rounded-lg">
                ...
                <div id="installation" className="bg-gray-50 p-4 rounded-lg">
            ...
            <ScrollAnimation direction="up" delay={0.6}>
              <div className="flex justify-center mt-8">
                <img 
                  ...
                  alt="Logo Shalom Security" 
                  className="rounded-lg shadow-md max-w-full h-auto hover:scale-105 transition-transform duration-300"
                />
              </div>
            </ScrollAnimation>
          </div>
