        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="lg:w-1/2 space-y-6">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-serif font-bold text-sholom-dark leading-tight">
              Trouvez votre <span className="text-sholom-primary italic">carrière</span>
            </h1>
            <p className="text-xl text-sholom-muted max-w-2xl">
              Opportunités professionnelles avec logement inclus
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-8">
              {[
                ...
                { icon: <Building className="h-5 w-5" />, text: "Logement inclus" },
                { icon: <CheckCircle className="h-5 w-5" />, text: "Formation continue" }
              ].map((benefit, index) => (
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-6">
                <div className="flex items-center text-white gap-4">
                  ...
                  <div className="ml-auto bg-white/20 backdrop-blur-sm rounded-lg px-3 py-1 text-sm">
                    <span className="font-semibold">Démarrage immédiat</span>
                  </div>
                </div>
              </div>
            </div>
